...
public class ClientSessionChannel<P extends AbstractPacket> extends SessionChannel<P, ClientSession> {
    ...
    public ClientSessionChannel(AbstractPacket.PacketType packetType, ClientSession session, GeneralLoop loop, PacketsFragmenter<P> fragmenter, PacketsAssembler<P> assembler, SecretKeyContext context) {
